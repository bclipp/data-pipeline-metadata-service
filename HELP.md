...
* The original package name 'com.yourcompany.pipeline-metadata-service' is invalid and this project uses 'com.yourcompany.pipeline_metadata_service' instead.
